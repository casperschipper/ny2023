...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {ah: fragment, ai: host, al: path, an: port_, aq: protocol, ar: query};
	});
...
var $author$project$Main$subscriptions = function (model) {
	...
	return $elm$core$Platform$Sub$batch(
		model.x ? _List_fromArray(
			[
				A2($elm$time$Time$every, ms, $author$project$Main$Tick)
			]) : _List_Nil);
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'width',
				$elm$json$Json$Encode$int(scrSize.u)),
				_Utils_Tuple2(
				'height',
...
var $author$project$Main$setInterval = F2(
	function (str, model) {
		var ms = A2(
			$elm$core$Maybe$withDefault,
			125,
	...
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				var str = msg.a;
				return _Utils_Tuple2(
					A2($author$project$Main$setInterval, str, model),
					$elm$core$Platform$Cmd$none);
		}
	});
			...
			A2(
				...
				function (opt) {
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('colorblock'),
								A2(
								$elm$html$Html$Attributes$style,
								'background-color',
								A2($author$project$Background$colorOfInt, 16, opt))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('\u00A0')
...
var $author$project$Main$viewEntry = F4(
	function (currentVoice, isCurrent, idx, _v0) {
		...
		var attrs = A2(
			$elm$core$List$cons,
			$elm$html$Html$Attributes$class('graph-entry'),
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Set the time interval'),
										$author$project$Main$newline,
										A2(
										$elm$html$Html$input,
										_List_fromArray(
											[
												$elm$html$Html$Events$onInput($author$project$Main$SetInterval),
												$elm$html$Html$Attributes$type_('number'),
							...
							return A2(
								...
								function (height) {
									return $elm$json$Json$Decode$succeed(
										{s: height, V: json, Z: seed, u: width});
								},
								A2($elm$json$Json$Decode$field, 'height', $elm$json$Json$Decode$int));
						},
