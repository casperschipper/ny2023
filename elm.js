								...
								return function (showControls) {
									return function (currentVoice) {
										return function (offset) {
											return {C: current, q: currentVoice, a: graph, l: history, h: index, S: $elm$core$Maybe$Nothing, J: offset, x: playing, o: rndSeed, G: scalePreset, p: screenSize, z: showControls};
										};
									};
								};
							};
...
var $author$project$Main$handleTick = function (model) {
	var mOptions = A2($elm$core$Array$get, model.C, model.a);
	if (mOptions.$ === 1) {
		...
		var _v1 = A2(
			...
			$author$project$Main$generateNext(g.v),
			model.o);
		var next = _v1.a;
		var nxtSeed = _v1.b;
		return _Utils_update(
...
var $author$project$Main$generateAll = function (model) {
	var num = A3($author$project$Background$numOfBlocks, model.p.t, model.p.r, $author$project$Main$blockSize);
	return A2(
...
var $author$project$Main$initGraph = function () {
	var fromIndex = function (idx) {
		...
		return {
			...
			B: $elm$core$String$fromInt(nextSlot)
		};
	};
...
var $author$project$Main$setOptions = F3(
	function (idx, opts, model) {
		var mEntry = A2($elm$core$Array$get, idx, model.a);
		if (!mEntry.$) {
			var g = mEntry.a;
			var newGraph = A3(
				$elm$core$Array$set,
...
var $author$project$Main$handleChangedInput = F3(
	function (idx, str, model) {
		...
		var entry = {
			v: $elm$core$Array$fromList(parseInts),
			f: A2(
				$elm$core$Maybe$withDefault,
				...
				A2(
					...
					A2($elm$core$Array$get, idx, model.a))),
			B: str
		};
		return _Utils_update(
			model,
			{
				a: A3($elm$core$Array$set, idx, entry, model.a)
			});
	});
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'array',
				A2($elm$json$Json$Encode$array, $elm$json$Json$Encode$int, g.v)),
				_Utils_Tuple2(
				'value',
				$elm$json$Json$Encode$string(g.B)),
				_Utils_Tuple2(
				'note',
				$author$project$Main$encodeNote(g.f))
			]));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'width',
				$elm$json$Json$Encode$int(scrSize.t)),
				_Utils_Tuple2(
				'height',
				$elm$json$Json$Encode$int(scrSize.r))
			]));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'history',
				A2($elm$json$Json$Encode$array, $elm$json$Json$Encode$int, model.l)),
				_Utils_Tuple2(
				'graph',
...
var $author$project$Main$getCurrentVoiceIndex = function (model) {
	var _v0 = _Utils_Tuple2(model.h, model.q);
	if (!_v0.a.b.b) {
		var _v1 = _v0.a;
		var idx = _v1.a;
		return idx;
			...
			A2(
				...
				A2(
					...
					A2(
						...
						A2($elm$core$Array$get, idx, history)))));
	});
		...
		function (idx) {
			return A2(
				...
				A2(
					$elm$core$Array$get,
					idx,
					$elm$core$Array$fromList($author$project$Main$majorScale)));
		},
		A2(
			$elm$random$Random$int,
			0,
				...
				model,
				{
					a: A3(
						...
						_Utils_update(
							g,
							{
								f: A2($author$project$Main$withOctave, oct, g.f)
							}),
						model.a)
				});
		} else {
				...
				model,
				{
					a: A3(
						...
						_Utils_update(
							g,
							{
								f: A2($author$project$Main$withPitchClass, pi, g.f)
							}),
						model.a)
				});
		} else {
		...
		var updateEntry = F2(
			function (pitch, _v1) {
				...
				return _Utils_update(
					g,
					{
						f: A2($author$project$Main$withPitchClass, pitch, g.f)
					});
			});
	...
	function (screenWidth, squareWidth, i) {
		...
		return _List_fromArray(
			[
				...
				$elm$core$String$fromInt(squareWidth)),
...
var $author$project$Background$cursorBox = F5(
	function (current, history, w, h, blockSize) {
		...
		var color = A2(
			$elm$core$Maybe$withDefault,
			0,
			A2($elm$core$Array$get, current, history));
		return A2(
			$elm$svg$Svg$svg,
			_List_fromArray(
				[
...
var $author$project$Main$lookupIndexInHistory = F2(
	function (idx, model) {
		return A2(
			$elm$core$Maybe$withDefault,
			-1,
		...
		if (!voiceNum) {
			...
			return A2(
				...
				A2(
					$elm$core$Maybe$map,
					function (idx2) {
						return A2($author$project$Main$lookupIndexInHistory, idx2, model);
					},
					A2(
						$elm$core$Array$get,
						nonZero,
		...
		A2(
			...
			A2(
				...
				$author$project$Main$viewEntry(
					A2($author$project$Main$getCurrentSlotForVoice, model.q, model)),
				model.a)));
	return {
		aA: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						A4($author$project$Background$backgroundSvg, model.l, model.p.t, model.p.r, $author$project$Main$blockSize)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				A2(
					...
					$author$project$Main$showIf(model.z)),
				_List_fromArray(
					[
							...
							return A2(
								...
								function (height) {
									return $elm$json$Json$Decode$succeed(
										{r: height, T: json, X: seed, t: width});
								},
								A2($elm$json$Json$Decode$field, 'height', $elm$json$Json$Decode$int));
						},
